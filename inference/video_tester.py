...
class InteractiveVideoTester:
    ...
    def __init__(self, model_path, reference_path=None, device='cuda'):
        ...
        # Store movement keypoints for comparison
        ...
        if n_frames > 0:
            ...
            if n_frames >= 3:
                ...
                middle_sim = self.calculate_pose_similarity(
                    movement_keypoints[mid_idx],
                    ref_keypoints[ref_mid_idx]
                )
    ...
    def draw_skeleton(self, frame, keypoints):
        ...
        # Define connections with colors (BGR format)
        connection_groups = {
            # Head & Face - Yellow
            "head": {
                "connections": [(0, 18), (17, 18), (0, 1), (0, 2), (1, 3), (2, 4)],
                "color": (0, 255, 255)
            },
            # Torso - Green
            "torso": {
                "connections": [(18, 5), (18, 6), (5, 6), (5, 11), (6, 12), (11, 12), (18, 19)],
                "color": (0, 255, 0)
            },
            # Left Arm - Blue
            "left_arm": {
            ...
            # Left Leg - Cyan
            "left_leg": {
                "connections": [(11, 13), (13, 15), (15, 20), (15, 22), (15, 24), (20, 22)],
                "color": (255, 255, 0)
            },
            # Right Leg - Magenta
            "right_leg": {
                "connections": [(12, 14), (14, 16), (16, 21), (16, 23), (16, 25), (21, 23)],
                "color": (255, 0, 255)
            },
        }
            ...
            if not paused:
                ...
                if movement_id is not None:
                    ...
                    if validated_movement is not None:
                        ...
                        # Store keypoints for current movement
                        ...
                        if movement_id != self.previous_movement and not self.sequence_complete:
                            ...
                            if self.previous_movement is not None and self.current_segment_start is not None:
                                ...
                                # Reset keypoints buffer for next movement
                                self.movement_keypoints_buffer = []
    ...
    def save_movement_segments(self, video_path, fps):
        ...
        # Add comparison scores to segments
...
def main():
    ...
    parser.add_argument('--reference', type=str, default=None,
                        help='Path to reference file for comparison')
    ...
    # Create tester
    tester = InteractiveVideoTester(model_path=model_path,  reference_path=args.reference, device=args.device)
    print(tester)
...
# python real_time.py --video "C:\Users\admin\Downloads\test.mp4" --save-video --output P011_with_scores.mp4
